...
export default function PortfolioPanel({ sectionId, onClose }: PortfolioPanelProps) {
  ...
  return (
    <div className="absolute inset-0 z-10 flex items-center justify-center bg-black/70 p-4">
      <div className="flex max-h-[90vh] w-full max-w-[calc(100vw-2rem)] flex-col border-4 border-[#6f5c9e] bg-[#1e1730] text-[#f2ecff] shadow-[6px_6px_0_0_rgba(0,0,0,0.5)] sm:max-w-xl md:max-w-2xl">
